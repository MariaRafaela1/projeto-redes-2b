...
* ``sudo ufw allow ssh``
<p><center> Figura 9: Configurando Firewall</center></p>
<img src="figures/firewallssh.png" alt=""
     title="Figura 9: Configurando Firewall" width="800" height="auto"/></br>

### Configurando conexões físicas
* colocar a placa de todas as VMs em modo bridge
<p><center> Figura 10: Placa de rede no modo bridge</center></p>
<img src="figures/placa em modo bridge.png" alt=""
     title="Figura 10: Placa de rede no modo bridge" width="800" height="auto"/></br>
...
<p><center> Figura 11: Placa de rede no modo Host-Only</center></p>
<img src="figures/placa host-only.png" alt=""
     title="Figura 11: Placa de rede no modo Host-Only" width="800" height="auto"/></br>
     
<p><center> Figura 12: Interface de rede</center></p>
<img src="figures/interface de rede.png" alt=""
     title="Figura 12: Interface de rede" width="800" height="auto"/></br>
     
<p><center> Figura 13: Adicionando enp0s8</center></p>
<img src="figures/netplan 8.png" alt=""
     title="Figura 13: Adicionando enp0s8" width="800" height="auto"/></br>
     
### Acessando VM pelo terminal do PC via SSH
<p><center> Figura 14: Acessando VM pelo terminal do PC via SSH</center></p>
<img src="figures/Captura de tela de 2022-08-10 10-29-09.png" alt=""
     title="Figura 14: Acessando VM pelo terminal do PC via SSH" width="800" height="auto"/></br>
     
### Editando arquivo hosts
* ``sudo nano /etc/hosts``
* adicionar informações da tabela

<p><center> Figura 15: Arquivo hosts editado</center></p>
<img src="figures/etc hosts 1 Rafa.png" alt=""
     title="Figura 15: Arquivo hosts editado" width="800" height="auto"/></br>
